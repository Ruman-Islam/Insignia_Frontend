...
const PhotoGallery = () => {
  return (
    <section className="pb-20 mt-16 bg-photo__gallery__background bg-center bg-cover relative">
      ...
      <div className="max-w-screen-xl mx-auto p-content__padding relative">
        ...
        >
          <div className="columns-1 gap-5 lg:gap-3 sm:columns-2 lg:columns-3 xl:columns-5 [&>img:not(:first-child)]:mt-5 lg:[&>img:not(:first-child)]:mt-3">
