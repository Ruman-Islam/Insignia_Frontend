...
const Banner = () => {
  return (
    <div className="w-full h-[400px] rounded-3xl bg-center shadow-lg relative">
      ...
      />
      <div className="absolute bottom-5 left-5 backdrop-blur-sm p-3 text-white border border-brand__gray__border rounded-3xl">
        <h4>5 Packages</h4>
